...
public class PictureTile extends Tile
{
	...
	public PictureTile(String name)
	{
		...
		image = Toolkit.getDefaultToolkit().getImage("images/" + name + ".png");
		image = Toolkit.getDefaultToolkit().getImage("images/" + name + ".png").getScaledInstance(80, 80, Image.SCALE_SMOOTH);
